...
import static ru.rusguardian.domain.TelegramDataEnum.FAVOURITES;

@Component
public class FavouritesCommand extends Command implements SendMessageService {

    private static final TelegramDataEnum TELEGRAM_DATA = FAVOURITES;
