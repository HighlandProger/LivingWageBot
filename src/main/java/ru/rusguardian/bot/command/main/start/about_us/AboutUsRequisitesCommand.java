...
import static ru.rusguardian.domain.TelegramDataEnum.ABOUT_US_REQUISITES;

@Component
public class AboutUsRequisitesCommand extends Command implements SendMessageService {

    private static final TelegramDataEnum TELEGRAM_DATA = ABOUT_US_REQUISITES;
    ...
    protected CommandName getType() {
        return CommandName.ABOUT_US_REQUISITES;
    }
